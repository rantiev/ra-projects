angular.module('ra-projects').controller('projectNewController', ['toaster', 'projectsService', 'settings', '$state', '$scope', function (toaster, projectsService, settings, $state, $scope) {
