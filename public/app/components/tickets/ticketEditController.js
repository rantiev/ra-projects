angular.module('ra-projects').controller('ticketEditController', ['toaster', 'ticketsService', 'ticket', 'users', '$state', '$scope', function (toaster, ticketsService, ticket, users, $state, $scope) {
